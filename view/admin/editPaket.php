...
$id = $_GET['id'];
$sql = "select * from tabel_paketharga where id = '$id' ";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Paket</h1>
                        ...
                        <div class="card-body">
                            <form action="../../action/function.php" method="post">
                                <div class="form-group w-75">
                                    ...
                                    <input type="text" value="<?= $row['nama_paket'] ?>" name="namaPaket" class="form-control">
                                </div>
                                <div class="form-group w-75">
                                    <label for="">Lama Pengerjaan ( hari ) </label>
                                    <input type="text" value="<?= $row['lama'] ?>" name="lama" class="form-control">
                                </div>
                                <div class="form-group w-75">
                                    <label for="">Harga</label>
                                    <input type="text" value="<?= $row['harga'] ?>" name="harga" class="form-control">
                                </div>
                                <input type="hidden" name="idPaket" value="<?= $row['id'] ?>">

                                <button type="submit" name="editPaket" class="my-3  btn  btn-primary">Edit Paket</button>
