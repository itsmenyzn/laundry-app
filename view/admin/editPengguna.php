                        ...
                        <div class="card-body w-100">
                            <form action="../../action/function.php" method="post">
                                ...
                                <div class="form-group w-75">
                                    ...
                                    <input type="password" disabled value="<?= $row['password'] ?>" name="password" class="form-control">
                                </div>
                                <div class="form-group w-75">
                                    <label for="">New Password</label>
                                    <input type="password" value="" placeholder="Password Baru..." name="password" class="form-control">
                                </div>
                                <div class="form-group w-75">
                                    <label for="">Level</label>
                                    <select class="custom-select mr-sm-2" value="<?= $row['username'] ?>" name="level" id="inlineFormCustomSelect">
                                        <option value="admin" <?php ($row['level'] == 'admin') ?  'selected' : '' ?>>Admin</option>
                                        <option value="user" <?php ($row['level'] == 'user') ?  'selected' : '' ?>>User</option>
                                    </select>

                                </div>
                                <button type="submit" name="editPengguna" class="my-3  btn  btn-primary">Edit Pengguna</button>
