                            ...
                            <form action="../../../action/function.php" method="post">
                                ...
                                <!-- <div class="form-group w-75">
                                    ...
                                    <select class="custom-select mr-sm-2" value="<?= $row['username'] ?>" name="level" id="inlineFormCustomSelect">
                                        <option value="admin" <?php //($row['level'] == 'admin') ?  'selected' : '' 
                                                                ?>>Admin</option>
                                        <option value="user" <?php //($row['level'] == 'user') ?  'selected' : '' 
                                                                ?>>User</option>
                                    </select>

                                </div> -->
                                <input type="hidden" value="<?= $row['id'] ?>" name="idAdmin">
                                <button type="submit" name="editProfileAdmin" class="my-3  btn  btn-primary">Edit Profile</button>
