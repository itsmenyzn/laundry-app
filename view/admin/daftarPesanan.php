                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="tambahPesanan.php" class="mb-3 btn  btn-primary float-right">Tambah Pesanan</a>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-between ">
                                                    <a href="../../view/admin/editPesanan.php?id= <?= $row['id'] ?>" class=" btn btn-info btn-circle btn-md">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="../../action/function.php?deletePesanan=1&id=<?= $row['id'] ?>" class="btn btn-danger"> Hapus </a>
                        </div>
                    </div>
                </div>
            </div>
