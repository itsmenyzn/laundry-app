                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Jenis Paket Laundry</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <a href="tambahPaket.php" class="mb-3 btn  btn-primary float-right">Tambah Paket</a>
                                ...
                                <table class="table table-bordered" id="dataPaket" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($query) == 0) {
                                            echo '<tr>
                                            <td colspan="5" class="text-center">Data Paket Belum Ada</td>
                                        </tr>';
                                        }
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-between ">
                                                    <a href="../../view/admin/editPaket.php?id= <?= $row['id'] ?>" class=" btn btn-info btn-circle btn-md">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="../../action/function.php?deletePaket=1&id=<?= $row['id'] ?>" class="btn btn-danger"> Hapus </a>
                        </div>
                    </div>
                </div>
            </div>
