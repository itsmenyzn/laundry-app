                        ...
                        <div class="card-body w-100">
                            <form action="../../action/function.php" method="post">
                                <div class="form-group w-75">
                                    ...
                                    <input type="text" name="namaPaket" class="form-control" placeholder="Nama Paket...">
                                </div>
                                <div class="form-group w-75">
                                    <label for="">Lama Pengerjaan</label>
                                    <input type="text" name="lama" class="form-control" placeholder="1 ( hari )">
                                </div>
                                <div class="form-group w-75">
                                    <label for="">Harga</label>
                                    <input type="text" name="harga" class="form-control" placeholder="Harga...">
                                </div>
                                <button type="submit" name="tambahPaket" class="my-3  btn  btn-primary">Tambah Paket</button>
