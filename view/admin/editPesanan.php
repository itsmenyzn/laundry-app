...
$id = $_GET['id'];
$sql = "select * from tabel_pesanan where id = '$id' ";
                    ...
                    <div class="card shadow my-3 col-lg-11">
                        <div class="card-body">
                            <form action="../../action/function.php" method="post">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group w-75">
                                            ...
                                            <select id="paket" class="custom-select mr-sm-2" name="paket" id="inlineFormCustomSelect">
                                                ...
                                                foreach ($data as $d) :
                                                ?>
                                                    <option <?php if ($row['nama_paket'] == $d['nama_paket']) {
                                                                echo 'selected';
                                                            } ?> value="<?= $d['nama_paket'] ?>"><?= $d['nama_paket'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                ...
                                <input type="hidden" name="idPesanan" value="<?= $row['id'] ?>">
                                ...
                                <button type="submit" name="editPesanan" class="my-3  btn  btn-primary">Edit Pesanan</button>
