                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="action/function.php" method="post">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input type="text" name="nama" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required placeholder="Nama Lengkap..." />
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input type="tel" name="telepon" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" required placeholder="08xx-xxxx-xxxx" />
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <center>
                                            <button type="submit" name="daftarUser" class="btn btn-primary btn-user btn-block w-50">
                                                Register
                                            </button>
                                        </center>
                                        <hr />
                                    ...
                                    <div class="text-center">
                                        <p class="small">
                                            Sudah punya akun ? <a class="small" href="login.php">Login Disini</a>
                                            </a>
                                        </p>
                                    </div>
                                </div>
